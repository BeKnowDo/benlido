...
class WC_URL_Coupons_Loader {
	...
	protected function load_framework() {
		...
		if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_0\\SV_WC_Data_Compatibility' ) ) {
		...
		if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_0\\SV_WC_Coupon_Compatibility' ) ) {
