...
registerBlockType( 'cgb/block-bl-basel-header', {
	...
	attributes: {
		super_header: {
			type: 'string',
			default: 'Enter Super Header...',
			selector: '.title-subtitle'
		},
		header: {
			type: 'string',
			default: 'Enter Header...',
			selector: 'h4.title'
		},
	},
		...
		return (
			...
			>
				<span className={classNames('title-subtitle', 'font-default')}
					...
					placeholder="Enter your super header"
				></span>
