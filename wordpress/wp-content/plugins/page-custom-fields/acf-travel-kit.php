...
if( function_exists('acf_add_local_field_group') ):
    ...
    Does not need the dollar sign.',
            ...
            array(
                'key' => 'field_5bb5eeb36ab1f',
                'label' => 'Lifestyle Icon',
                'name' => 'lifestyle_icon',
                'type' => 'image',
                'instructions' => 'Upload the lifestyle icon if this is a lifestyle kit',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'field_5bb630e22d4fc',
                'label' => 'Lifestyle Blurb',
                'name' => 'lifestyle_blurb',
                'type' => 'text',
                'instructions' => 'a short description of this lifestyle',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
